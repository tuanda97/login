...
class AuthUser(models.Model):
    id = models.AutoField(primary_key=True,blank=True,null=False)  # AutoField?
...
class Emailsent(models.Model):
    ...
    Email=models.TextField(blank=True,null=False,db_column='Email')
...
class EmailMassage(models.Model):
    ...
    content=models.TextField(blank=True,null=False,db_column='content')
    Is_see=models.IntegerField(blank=True,null=False,db_column='Is_see')
    Emailsent=models.TextField(db_column='Emailsent',blank=True,null=False)
    Emailto=models.TextField(db_column='Emailto',blank=True,null=False)
...
class SanPham(models.Model):
    ...
    tensp = models.CharField(blank=True, null=True,max_length=50)
